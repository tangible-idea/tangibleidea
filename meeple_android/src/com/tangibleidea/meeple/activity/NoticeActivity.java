...
public class NoticeActivity extends ListActivity 
{
    ...
    private class NoticeListAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                sv = new NoticeView(mContext, mTitles[position], mDialogue[position], mExpanded[position]);
            }
            else
            {
    ...
    {
    	private View mTreeButton;
        private TextView mTitle;
        private TextView mDialogue;
        
        public NoticeView(Context context, String title, String dialogue, boolean expanded)
        {
            super(context);
            ...
            RL_Title.setBackgroundColor(Color.rgb(230, 230, 230));
            	...
            	mTreeButton= new View(context);
            	mTreeButton.setBackgroundColor(Color.rgb(205, 205, 205));
            ...
            RL_Title.addView(mTreeButton, new RelativeLayout.LayoutParams(84, 88));
            RL_Title.addView(mTitle, new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, 88));
