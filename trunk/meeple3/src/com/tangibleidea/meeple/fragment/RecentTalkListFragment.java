...
public class RecentTalkListFragment extends ListFragment
{
    ...
    public static RecentTalkListFragment newInstance()
    {
    	RecentTalkListFragment f= new RecentTalkListFragment();
        return f;
    }
    ...
    {
        View v = inflater.inflate(R.layout.recent_talk, container, false);
        return v;
    }
